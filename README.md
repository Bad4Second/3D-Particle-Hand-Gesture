...
[![Webcam Interaction](https://img.shields.io/badge/Interaction-Webcam%20AI-00e5ff?style=for-the-badge)](https://bad4second.github.io)
[![Tech Stack](https://img.shields.io/badge/Tech%20Stack-HTML5%20%7C%20CSS3%20%7C%20JavaScript-orange?style=for-the-badge)](https://bad4second.github.io)
...
| **2** | **Satu Jari (Telunjuk Atas)** | **Saturnus 3D:** Partikel membentuk bola inti dengan cincin asteroid oranye yang berputar di pergelangan tangan. (jupiter) |
| **3** | **Dua Jari (Pose Peace)** | **I LOVE YOU Text:** Partikel bertransformasi presisi membentuk teks tipografi neon biru. |
| **4** | **Tangan Mengepal** | **Hati / Love:** Partikel meluncur membentuk geometri simbol hati berwarna merah muda. |
| **5** | **Tangan Terbuka (Lima Jari)** | **Buket Bunga Custom Name:** Partikel meluruh (transparan) dan memicu mekarnya buket bunga CSS penuh dari dasar layar. _(Ubah nama di file index.html line paling bawah)_ |
...
```bash
git clone [https://github.com/Bad4Second/3D-Particle-Hand-Gesture.git](https://github.com/Bad4Second/3D-Particle-Hand-Gesture.git)
